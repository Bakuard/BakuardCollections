...
/**
 * Последовательно перебирает элементы любой линейной структуры данных поддерживающей доступ к своим
 * элементам за константное время. Элементы можно перебирать в обоих направлениях.<br/>
