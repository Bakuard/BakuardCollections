...
public final class Deque<T> extends Queue<T> {
     ...
     * После добавления элементов в двустороннюю очередь, то порядок их следования будет тот же, что и
     ...
     * элементов в двустороннюю очередь, то порядок их следования будет тот же, что и в массиве.
