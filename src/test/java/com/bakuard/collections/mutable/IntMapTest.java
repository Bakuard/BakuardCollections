...
class IntMapTest {
    ...
    @Test
    @DisplayName("Copy constructor: empty IntMap -> copy is equivalent to original")
    public void copyConstructor1() {
        IntMap<Integer> original = new IntMap<>();
        IntMap<Integer> copy = new IntMap<>(original);

        Assertions.assertEquals(original, copy);
    }

    @Test
    @DisplayName("Copy constructor: not empty IntMap -> copy is equivalent to original")
    public void copyConstructor2() {
        IntMap<Integer> original = new IntMap<>();
        original.put(0, 10);
        original.put(10020, 100);
        original.put(377, 1000);
        IntMap<Integer> copy = new IntMap<>(original);
    ...
    @Test
    @DisplayName("Copy constructor: not empty IntMap -> changes to the original must not affect the copy")
    public void copyConstructor3() {
        ...
        original.put(377, 1000);
        IntMap<Integer> copy = new IntMap<>(original);
        IntMap<Integer> expected = new IntMap<>();
        expected.put(0, 10);
        expected.put(10020, 100);
        expected.put(377, 1000);

        original.put(17, 120);
        original.put(21, 1400);
        original.put(0, 1400);
        original.remove(10020);
